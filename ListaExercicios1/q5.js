...
function arrendoda(numero){
    
    result = `R$ ${numero.toFixed(2).toString().replace(".", ",")}` // o replace troca o . por ,
    return result
}

console.log(arrendoda(0.1 + 0.3))
console.log(arrendoda(0.5548798465498))
